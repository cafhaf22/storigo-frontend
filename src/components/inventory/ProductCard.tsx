        ...
        <div className="bg-white dark:bg-[#22243c] rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div className="p-4">
                ...
                <div>
                    ...
                    <div
                        className="text-base text-gray-100 dark:text-gray-200 text-center cursor-pointer"
                    ...
                    <div className="text-base text-gray-100 dark:text-gray-200 text-center">{product.id}</div>
                    </div>
                    {/* Precio */}
                    <div>
                ...
                <div>
                    ...
                    <div className="text-base text-gray-100 dark:text-gray-200 text-center">{getStockLevel(product.quantity)}</div>
                    </div>
                    {/* Cantidad */}
                    <div>
